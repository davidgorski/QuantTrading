...
BASE_API_URL = "https://ibkr_gatweway:5055/v1/api"
...
def dashboard():
    try:
        ...
        return 'Make sure you authenticate first then visit this page. <a href="https://qa-dg-quant-trader.com/login">Log in</a>'
